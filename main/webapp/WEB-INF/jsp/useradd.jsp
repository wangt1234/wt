...
<div class="right">
        ...
        <div class="providerAdd">
            <form id="userForm" name="userForm"   action=" ">
                ...
                <div>
                    <label for="idpicpath_1">头像选择：</label>
                    <input type="file" name="idpicpath_1" id="idpicpath_1" value=""><br>
                    <img style="width: 100px; height: 100px; margin-left: 210px" id="uploadImg">
                </div>
